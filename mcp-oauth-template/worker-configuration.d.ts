/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5016ec63b29c33d8fceadde28f4061df)
// Runtime types generated with workerd@1.20260310.1 2026-03-02 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "McpServerTemplate";
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").McpServerTemplate>;
	}
}
